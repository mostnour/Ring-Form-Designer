...
MyApp = New qApp {
	...
	*/
	...
	DesWin1 = new qwidget(){
                        ...
                        setwindowtitle("Design Window")
		//setText("Design Window")
	...
	vBtns =[
		new QPushButton(win1){setText("Button")},
		new QPushButton(win1){setText("Label")},
		new QPushButton(win1){setText("TextBox")},
		new QPushButton(win1){setText("List")}
		]
	...
	//adddockwidget(Qt_LeftDockWidgetArea,toolV,Qt_Horizontal)
             //adddockwidget(Qt_LeftDockWidgetArea,toolV,Qt_Vertical)
	#	Ring Form Designer
